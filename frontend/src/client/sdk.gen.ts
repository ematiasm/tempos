...
export class BackupsService {
     ...
     * @returns BackupRunStatusPublic Successful Response
     * @throws ApiError
     */
    ...
    /**
     * Read Backup Run Status
     * Get the state of the last/current manual backup run.
     * @returns BackupRunStatusPublic Successful Response
     * @throws ApiError
     */
    public static readBackupRunStatus(): CancelablePromise<BackupsReadBackupRunStatusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/backups/run-status'
        });
    }
...
export class BusinessSettingsService {
     ...
     * @returns BusinessLocalePublic Successful Response
     * @throws ApiError
     */
    public static readBusinessLocale(): CancelablePromise<BusinessSettingsReadBusinessLocaleResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/business-settings/locale'
        });
    }
     ...
     * @throws ApiError
     */
    public static uploadLogo(data: BusinessSettingsUploadLogoData): CancelablePromise<BusinessSettingsUploadLogoResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/business-settings/logo',
            formData: data.formData,
            mediaType: 'multipart/form-data',
            errors: {
                422: 'Validation Error'
     ...
     * @throws ApiError
     */
    public static deleteLogo(): CancelablePromise<BusinessSettingsDeleteLogoResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/business-settings/logo'
        });
...
export class CashSessionsService {
    /**
     * Read Current Cash Session
     * The currently open cash session, or null when none is open.
     * @returns unknown Successful Response
     * @throws ApiError
     */
    public static readCurrentCashSession(): CancelablePromise<CashSessionsReadCurrentCashSessionResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns CashSessionPublic Successful Response
     * @throws ApiError
     */
    public static openCashSession(data: CashSessionsOpenCashSessionData): CancelablePromise<CashSessionsOpenCashSessionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @param data The data for the request.
     * @param data.cashSessionId
     * @param data.requestBody
     * @returns CashSessionPublic Successful Response
     * @throws ApiError
     */
    public static closeCashSession(data: CashSessionsCloseCashSessionData): CancelablePromise<CashSessionsCloseCashSessionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/cash-sessions/{cash_session_id}/close',
            path: {
     ...
     * @param data.skip Items to skip
     * @param data.limit Items per page
     * @returns Page_CashSessionPublic_ Successful Response
     * @throws ApiError
     */
    public static readCashSessions(data: CashSessionsReadCashSessionsData = {}): CancelablePromise<CashSessionsReadCashSessionsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
    ...
    /**
     * Read Cash Session Report
     * The full closing report for a cash session (computed live).
     * @param data The data for the request.
     * @param data.cashSessionId
     * @returns CashSessionReport Successful Response
     * @throws ApiError
     */
    public static readCashSessionReport(data: CashSessionsReadCashSessionReportData): CancelablePromise<CashSessionsReadCashSessionReportResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/cash-sessions/{cash_session_id}/report',
            path: {
                cash_session_id: data.cashSessionId
            },
            errors: {
...
export class CustomersService {
     ...
     * @param data.dateFrom
     * @param data.dateTo
     * @returns CounterpartStatementPublic Successful Response
     * @throws ApiError
     */
    public static readCustomerStatement(data: CustomersReadCustomerStatementData): CancelablePromise<CustomersReadCustomerStatementResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/customers/{customer_id}/statement',
            path: {
                customer_id: data.customerId
            },
            query: {
     ...
     * @throws ApiError
     */
    public static emailCustomerStatement(data: CustomersEmailCustomerStatementData): CancelablePromise<CustomersEmailCustomerStatementResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/customers/{customer_id}/statement/email',
            path: {
                customer_id: data.customerId
            },
            body: data.requestBody,
...
export class DocumentsService {
     ...
     * @returns DocumentEmailStatus Successful Response
     * @throws ApiError
     */
    public static readEmailStatus(): CancelablePromise<DocumentsReadEmailStatusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/documents/email-status'
        });
    }
     ...
     * @throws ApiError
     */
    public static updateDocumentNotes(data: DocumentsUpdateDocumentNotesData): CancelablePromise<DocumentsUpdateDocumentNotesResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    public static emailDocument(data: DocumentsEmailDocumentData): CancelablePromise<DocumentsEmailDocumentResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/documents/{document_id}/email',
            path: {
                document_id: data.documentId
            },
            body: data.requestBody,
...
export class ProductsService {
     ...
     * @param data.skip Items to skip
     * @param data.limit Items per page
     * @returns Page_ProductListItemPublic_ Successful Response
     * @throws ApiError
     */
    ...
    /**
     * Read Product Category Counts
     * Aggregate product counts per category (None = uncategorized).
     * @returns ProductCategoryCountsPublic Successful Response
     * @throws ApiError
     */
    public static readProductCategoryCounts(): CancelablePromise<ProductsReadProductCategoryCountsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/products/counts-by-category'
        });
    }
...
export class ReportsService {
     ...
     * @param data.desde
     * @param data.hasta
     * @returns SalesByPaymentRow Successful Response
     * @throws ApiError
     */
    public static salesByPayment(data: ReportsSalesByPaymentData = {}): CancelablePromise<ReportsSalesByPaymentResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/reports/sales-by-payment',
            query: {
                desde: data.desde,
                hasta: data.hasta
            },
     ...
     * @param data.desde
     * @param data.hasta
     * @returns SalesByUserRow Successful Response
     * @throws ApiError
     */
    public static salesByUser(data: ReportsSalesByUserData = {}): CancelablePromise<ReportsSalesByUserResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/reports/sales-by-user',
            query: {
                desde: data.desde,
                hasta: data.hasta
            },
...
export class SetupService {
     ...
     * @returns SetupStatusPublic Successful Response
     * @throws ApiError
     */
    public static readSetupStatus(): CancelablePromise<SetupReadSetupStatusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static runSetup(data: SetupRunSetupData): CancelablePromise<SetupRunSetupResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/setup/',
            body: data.requestBody,
...
export class SuppliersService {
     ...
     * @throws ApiError
     */
    public static readSupplierStatement(data: SuppliersReadSupplierStatementData): CancelablePromise<SuppliersReadSupplierStatementResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/suppliers/{supplier_id}/statement',
            path: {
                supplier_id: data.supplierId
            },
            query: {
     ...
     * @throws ApiError
     */
    public static emailSupplierStatement(data: SuppliersEmailSupplierStatementData): CancelablePromise<SuppliersEmailSupplierStatementResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/suppliers/{supplier_id}/statement/email',
            path: {
                supplier_id: data.supplierId
            },
            body: data.requestBody,
